  ...
  return (
    <div className="glass-panel p-10 rounded-[2.5rem] border-none shadow-2xl space-y-8">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted text-sm font-medium opacity-60 italic font-serif">Continue your reading journey</p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted pl-4">Password</label>
          <input
            type="password"
            value={password}
      ...
      <div className="space-y-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-black">
            <span className="bg-surface px-4 text-muted">Or access via</span>
          </div>
        </div>
      ...
      <p className="text-center text-[10px] font-black uppercase tracking-[0.2em] text-muted">
        ...
        <Link href="/signup" className="text-accent underline font-black">
          Join REEDR
        </Link>
      </p>
    </div>
